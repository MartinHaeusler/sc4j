...
import org.neatutils.sc4j.api.annotation.EnumFactoryMethod;
...
import org.neatutils.sc4j.api.annotation.ValueAlias;
import org.neatutils.sc4j.api.annotation.ValueConverter;
...
public class ParameterMetadata {
	...
	public Class<? extends AbstractSchemaConf4jConfiguration> getConfigurationClass() {
		return (Class<? extends AbstractSchemaConf4jConfiguration>) this.field.getDeclaringClass();
	}
	...
	public Object getValue(final AbstractSchemaConf4jConfiguration config) {
	...
	public void setValue(final AbstractSchemaConf4jConfiguration chronoConfig, final Object parameterValue) {
	...
	public boolean isConditionallyRequiredIn(final AbstractSchemaConf4jConfiguration config) {
		checkNotNull(config, "Precondition violation - argument 'config' must not be NULL!");
	...
	public boolean isConditionallyIgnoredIn(final AbstractSchemaConf4jConfiguration config) {
		checkNotNull(config, "Precondition violation - argument 'config' must not be NULL!");
	...
	public boolean hasValueIn(final AbstractSchemaConf4jConfiguration chronoConfig) {
		checkNotNull(chronoConfig, "Precondition violation - argument 'chronoConfig' must not be NULL!");
